...
import { addTeam, deleteTeam, regenerateToken, reinstateTeam, removeTeamPhoto, setJoinCode, setRoster, setSeed, setSignupOpen, withdrawTeam } from '@/actions/teams';
...
export function TeamsAdmin({ slug, tournament: t, teams, tokens, baseUrl, joinCode }: {
  ...
  async function dropPhoto(fd: FormData) { 'use server'; redirectWithMsg(here, await removeTeamPhoto(slug, String(fd.get('teamId'))), 'Photo removed'); }
